WITH products AS (
    ...
    --could reference source source("thelook_ecommerce","orders") but we aren't referencing source. Source is something that is referenced in yml files
    --it is a base table not a reference from staging.
)
